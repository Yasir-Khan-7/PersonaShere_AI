      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-10">
        <div className="glass shadow-glow rounded-3xl border border-[color:var(--color-border)]/70 p-10 text-white">
          <div className="flex flex-wrap items-center gap-3 text-xs uppercase tracking-wide text-cyan-200">
            ...
            <span className="rounded-full border border-white/10 px-3 py-1">Secure by Clerk + Supabase</span>
          </div>
          <h1 className="mt-4 text-4xl font-semibold leading-tight sm:text-5xl">
            Role-based AI workspaces with secure auth and data.
          </h1>
          <p className="mt-3 text-lg text-[color:var(--color-muted)]">
            Sign up, choose a role, and land in a tailored Sphere. Clerk handles auth, Supabase stores
            orgs/roles/content, and the AI console is ready for Groq integration.
          </p>
